      ...
      <div className="p-3 sm:p-6 space-y-4 sm:space-y-6">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0">
          ...
          <div className="flex gap-2 w-full sm:w-auto">
            <Button variant="outline" size="sm" onClick={() => setShowConfigModal(true)} className="flex-1 sm:flex-none">
              <Settings className="w-4 h-4 sm:mr-2" />
              <span className="hidden sm:inline">Configure</span>
            </Button>
            <Button size="sm" onClick={() => setShowNewTaskModal(true)} className="flex-1 sm:flex-none">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          <Card className="bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200">
            <CardContent className="p-3 sm:p-6">
              ...
              <div className="text-xs sm:text-sm text-blue-700">Active Tasks</div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-green-50 to-green-100 border-green-200">
            <CardContent className="p-3 sm:p-6">
              ...
              <div className="text-xs sm:text-sm text-green-700">Completed Today</div>
            </CardContent>
          </Card>

          <Card className="hidden sm:block bg-gradient-to-br from-purple-50 to-purple-100 border-purple-200">
            <CardContent className="p-3 sm:p-6">
              <div className="flex items-center justify-between mb-2">
              ...
              <div className="text-xs sm:text-sm text-purple-700">Total Tasks Completed</div>
            </CardContent>
          </Card>

          <Card className="hidden sm:block bg-gradient-to-br from-orange-50 to-orange-100 border-orange-200">
            <CardContent className="p-3 sm:p-6">
              <div className="flex items-center justify-between mb-2">
              ...
              <div className="text-xs sm:text-sm text-orange-700">Avg Success Rate</div>
            </CardContent>
          </Card>
        </div>
