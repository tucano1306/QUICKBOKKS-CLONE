  ...
  try {
    ...
    const updatedAsset = await prisma.asset.update({
      ...
      data: {
        ...
        purchaseMileage: data.purchaseMileage !== undefined ? data.purchaseMileage : existingAsset.purchaseMileage,
        estimatedLifetimeMiles: data.estimatedLifetimeMiles !== undefined ? data.estimatedLifetimeMiles : existingAsset.estimatedLifetimeMiles,
        lastMileageUpdate: data.currentMileage !== undefined ? new Date() : existingAsset.lastMileageUpdate,
